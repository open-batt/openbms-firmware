...
- **SBS v1.1** — Smart Battery Specification version 1.1, used for standard battery-host communication. Built on top of SMBus, which itself is built on top of I²C physical layer.
- **CAN bus** — used for communication with the host.
- **UART** — used for debugging purposes.
