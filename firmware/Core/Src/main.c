...
int main(void)
{
  ...
  while (1)
  {
    //OpenBMS_Ctrl_Run();
    /* USER CODE END WHILE */
    HAL_UART_Transmit(&huart1, (uint8_t *)"Dobar dan\r\n", 11, 100);
    HAL_Delay(500);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, ADC_SYNC_Pin|ADC_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, CELL_2_BAL_Pin|DRV_FET_EN_Pin|MEAS_CELL_Pin|DRV_PRE_FET_EN_Pin
  ...
  /*Configure GPIO pins : CELL_2_BAL_Pin DRV_FET_EN_Pin MEAS_CELL_Pin DRV_PRE_FET_EN_Pin
                           CELL_7_BAL_Pin */
  GPIO_InitStruct.Pin = CELL_2_BAL_Pin|DRV_FET_EN_Pin|MEAS_CELL_Pin|DRV_PRE_FET_EN_Pin
                          |CELL_7_BAL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : DRV_FLT_Pin DRV_FLT_GD_Pin */
  GPIO_InitStruct.Pin = DRV_FLT_Pin|DRV_FLT_GD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : CELL_1_BAL_Pin DRV_MAIN_EN_Pin I2C2_INT_Pin PWR_ON_Pin
                           CELL_6_BAL_Pin MEAS_BATT_Pin CELL_5_BAL_Pin CELL_4_BAL_Pin
                           CELL_3_BAL_Pin */
  GPIO_InitStruct.Pin = CELL_1_BAL_Pin|DRV_MAIN_EN_Pin|I2C2_INT_Pin|PWR_ON_Pin
                          |CELL_6_BAL_Pin|MEAS_BATT_Pin|CELL_5_BAL_Pin|CELL_4_BAL_Pin
                          |CELL_3_BAL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : PWR_PG_Pin */
  GPIO_InitStruct.Pin = PWR_PG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PWR_PG_GPIO_Port, &GPIO_InitStruct);
